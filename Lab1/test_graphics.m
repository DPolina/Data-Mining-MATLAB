disp("Задание 8"); 
% Создайте файл test_graphic.m, в котором наберите приведенный код п. 10. 
% Сохраните полученный график в формате tiff с разрешением 200 dpi 
...
plot(x,y,'r')     % Построение графика функции
